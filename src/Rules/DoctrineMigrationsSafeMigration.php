...
class DoctrineMigrationsSafeMigration implements Rule
{
    ...
    /**
     * @param array<string,string>|null $blacklistedQueries
     */
    ...
    public function processNode(Node $node, Scope $scope): array
    {
        ...
        if (!$classReflection->isSubclassOfClass($this->reflectionProvider->getClass(AbstractMigration::class)) || 'up' !== $scopeMethod->getName()) {
            return [];
        }
